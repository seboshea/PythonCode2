...
def DropGun_Stats_All():    
    ...
    AreaFraction0,AreaFraction1,AreaFraction2,AreaRatio_2_1,AreaRatio_1_0,DiameterLevel0,DiameterLevel1,DiameterLevel2,FilledArea,VoidArea=GrayscaleRatiosDropGun(Particle_X, Particle_Y, PartGrayStatsWv, ParticleTime)
...
def CIP_TAS_DOF():
    ...
    Dof_D, Dof_Y_1=DOF_curve(1)
    Dof_D, Dof_Y_2=DOF_curve(2)
    Dof_D, Dof_Y_4=DOF_curve(4)
    Dof_D, Dof_Y_10=DOF_curve(10)
    Dof_D, Dof_Y_20=DOF_curve(20)
    Dof_D, Dof_Y_100=DOF_curve(100)
...
def PlotDiameterAF():
    ...
    PlotKorCorrD(D_KorolevCorr,DiameterLevel1,Particle_X,Figurename,PltTitle)
...
#_______________________________________________________________________________________
def GrayscaleRatiosDropGun(Particle_X, Particle_Y, ParticleStatsWv, ParticleTime):    
...
#        if (PartGrayStatsWv[i,3]==0 or PartGrayStatsWv[i,7]==0 or PartGrayStatsWv[i,11]==0 or PartGrayStatsWv[i,4]==63 or PartGrayStatsWv[i,8]==63 or PartGrayStatsWv[i,12]==63 or Particle_X[i]!=Particle_X[i]):
    ...
    return AreaFraction0,AreaFraction1,AreaFraction2,AreaRatio_2_1,AreaRatio_1_0,DiameterLevel0,DiameterLevel1,DiameterLevel2, FilledArea, VoidArea
...
def Avg_Areafraction_Diameter(D_KorolevCorr,AreaFraction0,AreaFraction1,AreaFraction2,DiameterLevel0,DiameterLevel1,DiameterLevel2,Particle_Y):
    ...
    AF_Level2_avg = [np.nanmean(x) for x in filtered_data]
    ...
    AF_Level1_avg = [np.nanmean(x) for x in filtered_data]
    ...
    AF_Level0_avg = [np.nanmean(x) for x in filtered_data]
    ...
    D_Level2_avg = [np.nanmean(x) for x in filtered_data]
    ...
    D_Level0_avg = [np.nanmean(x) for x in filtered_data]
    ...
    D_KorolevCorr_avg = [np.nanmean(x) for x in filtered_data]
...
#_______________________________________________________________________________________   
def PlotKorCorrD(D_KorolevCorr,Diameter, Particle_Y,Figurename,PltTitle):
