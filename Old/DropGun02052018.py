...
def DropGun_Stats_All():    
    ...
    AreaFraction0,AreaFraction1,AreaFraction2,AreaRatio_2_1,AreaRatio_1_0,DiameterLevel0,DiameterLevel1,DiameterLevel2,FilledArea,VoidArea,DiameterBG=GrayscaleRatiosDropGun(Particle_X, Particle_Y, PartGrayStatsWv, ParticleTime)
...
def PlotDiameterAF():
    ...
    Plot_BG_diameter(D_KorolevCorr,DiameterLevel1, D_BG_KorolevCorr, DiameterBG, Particle_X,Figurename,PltTitle,ActualDiameter)
...
#_______________________________________________________________________________________   
def Plot_BG_diameter(D_KorolevCorr,Diameter, D_BG_KorolevCorr, DiameterBg, Particle_Y,Figurename,PltTitle,ActualDiameter):
...
def PlotAFvsD(DropGun_Stats):
    ...
    for i in range(len(ExpList)):
        ...
        BinCentre=DropGun_Stats[ExpList[i]][6][:]
        AF_Level0_avg=DropGun_Stats[ExpList[i]][2][:]
        DOP=np.absolute(BinCentre-22)  # Distance from object plane 
