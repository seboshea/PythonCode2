...
def DataPaths():
    ...
    PathDict['C075','FileName2DS']='C075_20180123_2DS_AllIn.h5'
    ...
    PathDict['C074','FileName2DS']='C074_20180118_2DS_ALLin.h5'
...
def LoadFlightData2Dict(IncHVPS,IncNev,IncPSDs,FlightNumber,PathDict):
    ...
    if IncHVPS == 1:
        ...
        if IncPSDs==1 :
            NC_All_accept_CH1_core=ChangeTimeBase2DAvg(NC_DateTime,NC_All_accept_CH1_z,Time_Core, 1)       
            NC_HI_z_core=ChangeTimeBase2DAvg(NC_DateTime,NC_HI_z,Time_Core, 1) 
            NC_MI_z_core=ChangeTimeBase2DAvg(NC_DateTime,NC_MI_z,Time_Core, 1) 
            NC_LI_z_core=ChangeTimeBase2DAvg(NC_DateTime,NC_LI_z,Time_Core, 1) 
        
            FlightDict['NC_All_accept_HVPS_psd']=NC_All_accept_CH1_core
...
def PSD_runs_dict(PathDict, FlightStr,CSVPath,CSVName):
    ...
    for i in range(len(StartTime)):
        if (RunNumber[i] > 0) : 
            PSD_comparison_Dict(FlightDict, StartTime[i],EndTime[i],FilePath,'PSD_run_'+str(int(RunNumber[i])),'NC_All_accept')            
...
def PSD_comparison_Dict(FlightDict, StartTime,EndTime,FilePath,Figurename,Prefix):            
    ...
    #2DS
    NC_SizeMid_2DS, NC_z_dNdDp_2DS= Avg_OAP_dndDp_Dict(FlightDict, 'NC_2DS_size', 'Time_Core', Prefix+'_2DS_psd', StartTime,EndTime,1)   
    
    #HVPS
    NC_SizeMid_HVPS, NC_z_dNdDp_HVPS= Avg_OAP_dndDp_Dict(FlightDict, 'NC_HVPS_size', 'Time_Core', Prefix+'_HVPS_psd', StartTime,EndTime,1)
