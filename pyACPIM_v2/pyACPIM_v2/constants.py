...
'new_aerosol': [1000,500,2,0.5],'test': [1770,2560,2,0.6],                'sea salt': [58.44e-3, 2160, 2, 1.28],
                ...
                'test':[1,1,1,1],
                'SVC20': [160.17e-3, 1280, 1.2304, 0.1, 150e3],
                'SVC1': [146e-3, 1360, -0.0716, 0.01, 150e3],
                'SVC100': [132.1146e-3, 1300, 2.0253, 0.1, 150e3],
                'SVC400' : [144.13e-2, 1534, 2.5821, 0.1, 150e3],
                'SV02': [200e-3, 1500, 1, 0.067, 150e3],
                'SV03': [200e-3, 1500, 1, 0.067, 150e3]}
                #'Contents' :['molecular weight (kg/mol)','density (kg/m3)'
                           #  ,'CSTAR','kappa']}

semi_vol_dict = {'SVC20': [160.17e-3, 1280, 1.2304, 0.1, 150e3,1],
                 'SVC1': [146e-3, 1360, -0.0716, 0.1, 150e3,1],
                 'SVC100': [132.1146e-3, 1300, 2.0253, 0.1, 150e3, 1],
                 'SVC400' : [144.13e-3, 1534, 2.5821, 0.1, 150e3, 1],
                 'SV02': [200e-3, 1500, 1, 0.067, 150e3],
                 'SV03': [200e-3, 1500, 1, 0.067, 150e3]}
